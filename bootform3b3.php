...
<div class="container">
  <h4 style="font-family: verdana ">STTP/Seminar/Workshop/Symposium/FDP Conducted</h4>
...
<div class="form-group" style="width: 1500px">  
    <label class="control-label col-sm-2" style=" text-align: left">Number of Participants:</label>
    <div class="col-sm-10">
       <input type="text" style="width:500px; height:19" placeholder="" id="participants"> 
</div>
</div>
...
var dataString = 'title='+ title + '&participants='+ participants + 
'&type='+ type + '&date='+ date;
if(title==''||participants==''||type==''||date=='')
{
...
<center>
   <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <a type="submit" class="btn btn-default" href="bootform3b4.php">Save & Next</a>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
